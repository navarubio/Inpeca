...
import Jpa.ContribuyenteFacade;
...
@ManagedBean(name = "contribuyenteController")
@SessionScoped
public class ContribuyenteController implements Serializable {

    @EJB
    private Jpa.ContribuyenteFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("ContribuyenteCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("ContribuyenteUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("ContribuyenteDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public static class ContribuyenteControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Contribuyente) {
                ...
                return getStringKey(o.getIdcontribuyente());
            } else {
